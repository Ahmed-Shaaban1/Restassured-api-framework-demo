...
public class BooksTests {
	...
	public void testCreateBook_HappyPath() {
		int dynamicId = faker.number().numberBetween(1000, 9999);
		...
		book.setPublishDate("2025-07-28T00:00:00Z"); 
	...
	public void testUpdateBook_HappyPath() {
		...
		updated.setId(12);
		updated.setTitle(faker.book().title());
		updated.setDescription(faker.lorem().sentence());
		updated.setPageCount(faker.number().numberBetween(100, 300));
		updated.setExcerpt(faker.lorem().paragraph());
		updated.setPublishDate("2025-07-28T00:00:00Z");
